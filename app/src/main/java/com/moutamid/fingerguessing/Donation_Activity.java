...
public class Donation_Activity extends AppCompatActivity implements BillingProcessor.IBillingHandler {
//    BillingClient billingClient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.twohundred).setOnClickListener((View.OnClickListener) view -> {
            bp.purchase(Donation_Activity.this, Constants.TWO_HUNDRED_DOLLAR_PRODUCT);
        });

        findViewById(R.id.twotwofive).setOnClickListener((View.OnClickListener) view -> {
            bp.purchase(Donation_Activity.this, Constants.TWO_TWENTY_FIVE_DOLLAR_PRODUCT);
        });

        findViewById(R.id.twofoursix).setOnClickListener((View.OnClickListener) view ->
                bp.purchase(Donation_Activity.this, Constants.TWO_FORTY_SIX_DOLLAR_PRODUCT)
        );
        findViewById(R.id.twosixfive).setOnClickListener((View.OnClickListener) view ->
                bp.purchase(Donation_Activity.this, Constants.TWO_SIXTY_FIVE_DOLLAR_PRODUCT)
        );
        findViewById(R.id.threehundred).setOnClickListener((View.OnClickListener) view ->
                bp.subscribe(Donation_Activity.this, Constants.THREE_HUNDRED_DOLLAR_PRODUCT)
        );
    ...
    public void onProductPurchased(@NonNull String productId, @Nullable PurchaseInfo details) {
        Toast.makeText(Donation_Activity.this, "Purchase successful", Toast.LENGTH_SHORT).show();
    ...
    public void onBillingError(int errorCode, @Nullable Throwable error) {
        Toast.makeText(Donation_Activity.this, "onBillingError: code: " + errorCode + " \n" + error.getMessage(), Toast.LENGTH_SHORT).show();
    }
